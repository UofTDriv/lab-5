...
public class LogoutPresenter implements LogoutOutputBoundary {
    ...
    public void prepareFailView(String error) {
        ...
        // if this is an app that ever has to interact with the internet, nope. when you are dealing with user's and
        // their networks, every request can and will fail. also, could prevent maliciously constructed requests from
        // causing the database to misbehave. logout isn't a super common entry point, but it's not unheard of.
    }
}
